    ...
    <div className="p-5 md:p-8">
      <div className="flex flex-col md:flex-row gap-5 items-center">
        ...
        <div className=" space-y-3 md:w-1/2">
          <h2 className="font-bold text-2xl md:text-4xl">Manage Projects with <span className="bg-[#6E24A8] text-white">Precision</span> and <span className="bg-[#6E24A8] text-white">Flexibility</span></h2>
          ...
          <Button className="hidden md:flex text-white  font-semibold bg-[#6E24A8] text-lg w-40 ">Start Now</Button>
        </div>
        {/* Image */}
